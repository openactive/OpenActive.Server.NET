# Copy common from BookingSystem.AspNetCore into BookingSystem.AspNetFramework
# This helps keep the two examples in sync

cp ./BookingSystem.AspNetCore/IdComponents/* ./BookingSystem.AspNetFramework/IdComponents/
