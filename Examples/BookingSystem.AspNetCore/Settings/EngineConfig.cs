        ...
        public static StoreBookingEngine CreateStoreBookingEngine(string baseUrl)
        {
            return new StoreBookingEngine(
                ...
                new DatasetSiteGeneratorSettings
                {
                    ...
                    OrganisationPlainTextDescription = "The OpenActive Reference Implementation provides an example of an full conformant implementation of the OpenActive specifications.",
