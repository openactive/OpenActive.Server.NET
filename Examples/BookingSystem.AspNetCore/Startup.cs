...
namespace BookingSystem.AspNetCore
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var baseUrl = Configuration["ApplicationHostBaseUrl"] ?? "https://localhost:5001";

            // Configuration for the reference implementation to be used in either mode, for testing purposes.
            // Note that both modes do not need to be supported by in an actual implementation.
            var useSingleSellerMode = Configuration["UseSingleSellerMode"] == "true";
